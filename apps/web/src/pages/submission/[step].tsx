...
const Submission = () => {
  ...
  return (
    <>
      <div className='grow bg-bc-light-background flex justify-center md:pt-11 pt-5'>
        <div className='h-min w-full xl:w-layout mx-2 mb-12'>
          ...
          <section className='mb-7'>
            ...
            <p className='mb-4'>
              ...
              <ExternalLink href='/assets/EHPR-FAQs-Mar-2025.pdf'>FAQs</ExternalLink>.
            </p>
            <p className='mb-4'>
          ...
          <div className='bg-white rounded-sm' ref={formRef}>
